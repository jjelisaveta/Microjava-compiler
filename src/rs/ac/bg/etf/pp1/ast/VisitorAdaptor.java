...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(FacorType FacorType) { visit(); }
    public void visit(FactorTypeConst FactorTypeConst) { visit(); }
    public void visit(FactorParen FactorParen) { visit(); }
    public void visit(FactorNoParen FactorNoParen) { visit(); }
    public void visit(TermFactor TermFactor) { visit(); }
    public void visit(Terms Terms) { visit(); }
    public void visit(NoAddopList NoAddopList) { visit(); }
    public void visit(AddOpsList AddOpsList) { visit(); }
    public void visit(ExprMinus ExprMinus) { visit(); }
    public void visit(ExprMinusAddop ExprMinusAddop) { visit(); }
    public void visit(ExprPlus ExprPlus) { visit(); }
    public void visit(ExprPlusAddop ExprPlusAddop) { visit(); }
    ...
    public void visit(ErrorAssignStmt ErrorAssignStmt) { visit(); }
    ...
    public void visit(DesignatorStmtFuncCall DesignatorStmtFuncCall) { visit(); }
    public void visit(DesignatorStmtAssign DesignatorStmtAssign) { visit(); }
    public void visit(OneStmt OneStmt) { visit(); }
    public void visit(StmtList StmtList) { visit(); }
    public void visit(Stmts Stmts) { visit(); }
    public void visit(OneNumber OneNumber) { visit(); }
    public void visit(NumConstsList NumConstsList) { visit(); }
    ...
    public void visit(MethodDeclNoStmt MethodDeclNoStmt) { visit(); }
    public void visit(MethodDeclStmt MethodDeclStmt) { visit(); }
    ...
    public void visit(ErrorClassName ErrorClassName) { visit(); }
    ...
    public void visit(OneArrayVariableDecl OneArrayVariableDecl) { visit(); }
    public void visit(OneVariableDecl OneVariableDecl) { visit(); }
    public void visit(ConstantDecl ConstantDecl) { visit(); }
    public void visit(ConstantDecls ConstantDecls) { visit(); }
    ...
    public void visit(NoMetodDecl NoMetodDecl) { visit(); }
    public void visit(MethodsDecl MethodsDecl) { visit(); }
